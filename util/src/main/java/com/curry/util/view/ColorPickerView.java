 ...
 * @program: Toolt
 * @author: 陈博文
 * @create: 2022-07-24 00:22
 * @description: 挑选颜色的View
 **/
public class ColorPickerView extends View {
    ...
    public ColorPickerView(Context context, int height, int width, int initialColor) {
        ...
        Shader s = new SweepGradient(0, 0, mCircleColors, null);//环形渐变
        ...
        rectLeft = -r - mPaint.getStrokeWidth() / 2;
        rectTop = r + mPaint.getStrokeWidth() / 2 + mLinePaint.getStrokeMiter() / 2 + 15;
        rectRight = r + mPaint.getStrokeWidth() / 2;
